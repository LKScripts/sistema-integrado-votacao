...
<body>
    <header class="site">
        <nav class="navbar">
            ...
            <ul class="links">
                <li><a href="../../pages/guest/index.php" class="active">Home</a></li>
        ...
        <div class="container">
            ...
            <div class="guest-container">
                <div class="guest-text-container">
                    ...
                    <p>O botão estará disponível apenas durante o período de inscrições.</p>
                </div>
            ...
            <div class="guest-container">
                ...
                <div class="guest-text-container">
                    <h2>Suporte</h2>
                    <p>Encontrou dificuldades no acesso ou esqueceu suas credenciais?

                        Clique <a href="suporte.php">aqui</a> ou no botão abaixo para maiores informações.</p>
                    <a href="suporte.php" class="button primary">Suporte</a>
                </div>
            </div>
