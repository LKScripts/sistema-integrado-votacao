 ...
 * Exemplo de cron: 0,15,30,45 * * * * php /path/to/processar-notificacoes.php
 *
 * Ou pode ser executado manualmente:
 * php processar-notificacoes.php
 */
...
if (php_sapi_name() !== 'cli') {
    ...
    if (!isset($_GET['token']) || $_GET['token'] !== md5('notificacao_cron_' . date('Y-m-d-H'))) {
        die('Acesso negado. Execute via CLI: php processar-notificacoes.php');
    }
}
